...
| 12a | tx haptics on triggers navigator.vibrate in startIambic with timed duration | navigator.vibrate called with finite duration (toneUnits * UNIT_MS) in startIambic, not 99999 |
| 12b | tx haptics does not trigger navigator.vibrate in keyPress or keyRelease | navigator.vibrate not called when keyPress/keyRelease are called directly |
